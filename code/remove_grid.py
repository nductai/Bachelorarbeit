...
for threshold in threshold_values:
    ...
    threshold_dir = os.path.join(image_output_dir, f'threshold_{thresh_str}')
    image_dir = os.path.join(threshold_dir, 'images')
    mask_dir = os.path.join(threshold_dir, 'masks')
    ...
    for iteration in range(1, iterations + 1):
        ...
        # save outputs
        output_image_path = os.path.join(image_dir, f'{image_name}_thresh_{thresh_str}_{iteration:04d}{ext}')
        heatmap_path = os.path.join(mask_dir, f'heatmap_{iteration:04d}.npy')
        count_path = os.path.join(mask_dir, f'count_{iteration:04d}.npy')
